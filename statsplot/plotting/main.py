...
def plot(
    ...
    color_limits: Sequence[float] = None,
    ...
    Args:
        ...
        mode: One of :obj:`~statsplot.plot_specifiers.data.TraceMode` value.
        ...
        normalizer_x: The normalizer for the `x` dimension. One of :obj:`~statsplot.plot_specifiers.data.NormalizationType` value.
        normalizer_y: The normalizer for the `y` dimension. One of :obj:`~statsplot.plot_specifiers.data.NormalizationType` value.
        normalizer_z: The normalizer for the `z` dimension. One of :obj:`~statsplot.plot_specifiers.data.NormalizationType` value.
        ...
        fit: One of :obj:`~statsplot.plot_specifiers.data.RegressionType` value. Computes and plot the corresponding regression.
...
def barplot(
    ...
    Args:
        ...
        axis: One of :obj:`~statsplot.plot_specifiers.layout.AxisFormat` value.
        opacity: A numeric value in the (0, 1) interval to specify marker opacity.
        barmode: One of :obj:`~statsplot.plot_specifiers.layout.BarMode` value.
        error_bar: The name of the column in `data` with values to plot error bar.
        aggregation_func: One of :obj:`~statsplot.plot_specifiers.data.AggregationType` value.
        x_label: A string to label the x_axis in place of the corresponding column name in `data`.
        y_label: A string to label the y_axis in place of the corresponding column name in `data`.
        title: A string for the title of the plot.
        x_range: A tuple defining the (min_range, max_range) of the x_axis.
...
def catplot(
    ...
    Args:
        ...
        axis: One of :obj:`~statsplot.plot_specifiers.layout.AxisFormat` value.
        opacity: A numeric value in the (0, 1) interval to specify marker opacity.
        plot_type: One of :obj:`~statsplot.plot_specifiers.trace.CategoricalPlotType` value.
        jitter_x: A numeric value to specify jitter amount on the `x` dimension.
        jitter_y: A numeric value to specify jitter amount on the `y` dimension.
        normalizer: One of :obj:`~statsplot.plot_specifiers.data.NormalizationType` value.
        size: A numeric value or the name of the column in `data` with values to assign mark sizes.
        x_label: A string to label the x_axis in place of the corresponding column name in `data`.
        y_label: A string to label the y_axis in place of the corresponding column name in `data`.
        title: A string for the title of the plot.
...
def distplot(
    ...
    Args:
        ...
        histnorm: One of :obj:`~statsplot.plot_specifiers.data.HistogramNormType` value.
        central_tendency: One of :obj:`~statsplot.plot_specifiers.data.CentralTendencyType` value.
...
def jointplot(
    ...
    Args:
        ...
        axis: One of :obj:`~statsplot.plot_specifiers.layout.AxisFormat` value.
        opacity: A numeric value in the (0, 1) interval to specify marker opacity.
        marginal_plot: One of :obj:`~statsplot.plot_specifiers.trace.MarginalPlotDimension` value.
        ...
        central_tendency: One of :obj:`~statsplot.plot_specifiers.data.CentralTendencyType` value.
        barmode: One of :obj:`~statsplot.plot_specifiers.layout.BarMode` value.
        plot_type: One of :obj:`~statsplot.plot_specifiers.trace.JointplotType` value.
        opacity: A numeric value in the (0, 1) interval to specify marker opacity.
        jitter_x: A numeric value to specify jitter amount on the `x` dimension.
        jitter_y: A numeric value to specify jitter amount on the `y` dimension.
        normalizer_x: The normalizer for the `x` dimension. One of :obj:`~statsplot.plot_specifiers.data.NormalizationType` value.
...
def heatmap(
    ...
    Args:
        ...
        axis: One of :obj:`~statsplot.plot_specifiers.layout.AxisFormat` value.
        opacity: A numeric value in the (0, 1) interval to specify marker opacity.
        normalizer: The normalizer for the `z` dimension. One of :obj:`~statsplot.plot_specifiers.data.NormalizationType` value.
        x_label: A string to label the x_axis in place of the corresponding column name in `data`.
        y_label: A string to label the y_axis in place of the corresponding column name in `data`.
        z_label: A string to label the y_axis in place of the corresponding column name in `data`.
